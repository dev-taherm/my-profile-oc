...
export async function generateMetadata({
  ...
  const titles: Record<Locale, string> = {
    en: "Privacy Policy — Taher Mahram",
    ar: "سياسة الخصوصية — طاهر محرم",
  };

  const descriptions: Record<Locale, string> = {
    en: "Privacy policy for taher.pixovagency.com. Learn how I collect, use, and protect your information.",
    ar: "سياسة الخصوصية لموقع taher.pixovagency.com. تعرّف على كيفية جمع معلوماتك واستخدامها وحمايتها.",
  };
...
export default async function PrivacyPage({
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: dict.privacy.title },
    ],
  };
    ...
    <>
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-16">
          <PageHeader title={dict.privacy.title} subtitle={dict.privacy.subtitle} />
          <div className="max-w-3xl mx-auto">
            <Breadcrumb
              ...
              locale={locale}
            />
            <p className="text-sm text-muted-foreground mb-8">{dict.privacy.lastUpdated}</p>
