...
- **إدارة المشاريع** -- إنشاء وتعديل وحذف المشاريع مع تبويبات الترجمة (إنجليزي/عربي)، روابط GitHub/الموقع، علامة مميزة، وحالة النشر (مسودة/منشور/مؤرشف)
- **إدارة المدونة** -- إنشاء وتعديل وحذف المقالات مع محتوى Markdown، وقت القراءة، علامة مميزة، وحالة النشر
- **إدارة التصنيفات** -- إنشاء وحذف التصنيفات لتنظيم المشاريع والمقالات
- **إدارة الوسوم** -- إنشاء وحذف الوسوم لتصنيف المحتوى بدقة
...
| الحقل | القيمة |
|---|---|
| البريد الإلكتروني | المحدد في متغير البيئة `ADMIN_EMAIL` |
| كلمة المرور | المحدد في متغير البيئة `ADMIN_PASSWORD` |
...
- **إنشاء/تعديل** -- محرر كامل مع:
  - **بطاقة الإعدادات** -- الرابط المختصر، رابط GitHub، رابط الموقع، خيار مميز، قائمة الحالة (مسودة/منشور/مؤرشف)
...
- **إنشاء/تعديل** -- محرر كامل مع:
  - **بطاقة الإعدادات** -- الرابط المختصر، خيار مميز، وقت القراءة، قائمة الحالة (مسودة/منشور/مؤرشف)
...
- **التصنيفات** -- إنشاء وحذف التصنيفات (مثل: Backend, AI/LLM, Full-Stack, DevOps) لتنظيم المشاريع والمقالات
- **الوسوم** -- إنشاء وحذف الوسوم (مثل: Python, Django, React, Docker) لتصنيف المحتوى بدقة عبر المشاريع والمقالات
...
| `/api/projects` | POST | نعم | إنشاء مشروع جديد مع الترجمات |
| `/api/projects?id={id}` | PUT | نعم | تعديل مشروع موجود. يستبدل الترجمات |
...
| `/api/blog` | POST | نعم | إنشاء مقال جديد مع الترجمات |
| `/api/blog?id={id}` | PUT | نعم | تعديل مقال موجود. يستبدل الترجمات |
...
│   │
│   └── middleware.ts              # اكتشاف اللغة والتوجيه وإعادة التوجيه
│
...
| `ADMIN_EMAIL` | نعم | عنوان البريد الإلكتروني لتسجيل الدخول |
